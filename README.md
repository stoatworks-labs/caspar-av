...
**[v0.1.3](https://github.com/stoatworks-labs/caspar-av/releases/tag/v0.1.3)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Apple Silicon · .dmg disk image (CLI) | [`caspar-av-0.1.3-macos-aarch64-cli.dmg`](https://github.com/stoatworks-labs/caspar-av/releases/download/v0.1.3/caspar-av-0.1.3-macos-aarch64-cli.dmg) | 5.8 MB |
| Intel · .dmg disk image (CLI) | [`caspar-av-0.1.3-macos-x86_64-cli.dmg`](https://github.com/stoatworks-labs/caspar-av/releases/download/v0.1.3/caspar-av-0.1.3-macos-x86_64-cli.dmg) | 6.0 MB |
| Apple Silicon · .pkg installer (CLI) | [`caspar-av-0.1.3-macos-aarch64-cli.pkg`](https://github.com/stoatworks-labs/caspar-av/releases/download/v0.1.3/caspar-av-0.1.3-macos-aarch64-cli.pkg) | 5.5 MB |
| Intel · .pkg installer (CLI) | [`caspar-av-0.1.3-macos-x86_64-cli.pkg`](https://github.com/stoatworks-labs/caspar-av/releases/download/v0.1.3/caspar-av-0.1.3-macos-x86_64-cli.pkg) | 5.7 MB |
| Apple Silicon · .tar.gz archive | [`caspar-av-macos-aarch64.tar.gz`](https://github.com/stoatworks-labs/caspar-av/releases/latest/download/caspar-av-macos-aarch64.tar.gz) | 5.5 MB |
| Intel · .tar.gz archive | [`caspar-av-macos-x86_64.tar.gz`](https://github.com/stoatworks-labs/caspar-av/releases/latest/download/caspar-av-macos-x86_64.tar.gz) | 5.6 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`caspar-av-0.1.3-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/caspar-av/releases/download/v0.1.3/caspar-av-0.1.3-windows-x86_64-setup.exe) | 4.6 MB |
| ARM64 · .exe installer | [`caspar-av-0.1.3-windows-aarch64-setup.exe`](https://github.com/stoatworks-labs/caspar-av/releases/download/v0.1.3/caspar-av-0.1.3-windows-aarch64-setup.exe) | 4.4 MB |
| x64 · .zip archive | [`caspar-av-windows-x86_64.zip`](https://github.com/stoatworks-labs/caspar-av/releases/latest/download/caspar-av-windows-x86_64.zip) | 5.2 MB |
| ARM64 · .zip archive | [`caspar-av-windows-aarch64.zip`](https://github.com/stoatworks-labs/caspar-av/releases/latest/download/caspar-av-windows-aarch64.zip) | 5.1 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .deb package (Debian/Ubuntu) | [`caspar-av_0.1.3_amd64.deb`](https://github.com/stoatworks-labs/caspar-av/releases/download/v0.1.3/caspar-av_0.1.3_amd64.deb) | 2.9 MB |
| ARM64 · .deb package (Debian/Ubuntu) | [`caspar-av_0.1.3_arm64.deb`](https://github.com/stoatworks-labs/caspar-av/releases/download/v0.1.3/caspar-av_0.1.3_arm64.deb) | 3.0 MB |
| x64 · .rpm package (Fedora/RHEL) | [`caspar-av-0.1.3-1.x86_64.rpm`](https://github.com/stoatworks-labs/caspar-av/releases/download/v0.1.3/caspar-av-0.1.3-1.x86_64.rpm) | 3.0 MB |
| ARM64 · .rpm package (Fedora/RHEL) | [`caspar-av-0.1.3-1.aarch64.rpm`](https://github.com/stoatworks-labs/caspar-av/releases/download/v0.1.3/caspar-av-0.1.3-1.aarch64.rpm) | 3.1 MB |
| x64 · .tar.gz archive | [`caspar-av-linux-x86_64.tar.gz`](https://github.com/stoatworks-labs/caspar-av/releases/latest/download/caspar-av-linux-x86_64.tar.gz) | 5.8 MB |
| ARM64 · .tar.gz archive | [`caspar-av-linux-aarch64.tar.gz`](https://github.com/stoatworks-labs/caspar-av/releases/latest/download/caspar-av-linux-aarch64.tar.gz) | 5.8 MB |
